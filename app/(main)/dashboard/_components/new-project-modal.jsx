                            ...
                            <Alert className="bg-amber-500/10 border-amber-500/20">
                                ...
                                <AlertDescription className="text-amber-300/80">
                                    ...
                                    {currentProjectCount === 2
                                        ? "This will be your last free project. Upgrade to Pixlyze Pro for unlimited projects."
                                        : "Free plan is limited to 3 projects. Upgrade to Pixlyze Pro for unlimited projects."
                                    }
                                </AlertDescription>
                            </Alert>
                        )}
                        ...
                        {!selectedFile ? (
                            ...
                            >
                                ...
                                <p className="text-sm text-white/50">
                                    Support PNG, JPG, WEBP and GIF up to 20MB
                                </p>
                            </div>
                        ) : (
                            <div className="space-y-6">
