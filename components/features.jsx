...
const FeaturesSection = () => {
  ...
  const features = [
    {
      icon: <Crop color="#ff8fa0" size={iconSize}/>,
    ...
    {
      icon: <Scaling color="#bb36bb" size={iconSize} />,
    ...
    {
      icon: <Sparkles color="#b1b13c" size={iconSize} />,
    ...
    {
      icon: <FilePenLine color="#38c299" size={iconSize} />,
    ...
    {
      icon: <Image color="#c77d51" size={iconSize} />,
    ...
    {
      icon: <Proportions color="#51bac7" size={iconSize} />,
      title: "AI Upscaler",
      description:
