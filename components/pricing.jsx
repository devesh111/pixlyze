  ...
  return (
    <div
      ...
      className={`relative backdrop-blur-lg border rounded-3xl p-8 transition-all duration-700 cursor-pointer ${
        featured
          ? "bg-gradient-to-b from-purple-500/20 to-pink-600/20 border-purple-400/50 scale-105"
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 font-light mb-2">
            Unlock the full potential of AI-powered image editing with our flexible pricing plans. 
          </p>
          <p className="text-sm text-gray-300 font-light mb-4">(No hidden fees, cancel anytime.)</p>
        </div>
